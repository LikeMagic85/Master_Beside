...
sealed class AppState{
    ...
    data class MasterPage(val master: Master,val isMy: Boolean, val isEmailVer: Boolean):AppState()
    data class MyProfile(val master: Master, val isMy: Boolean, val editState:Boolean):AppState()
